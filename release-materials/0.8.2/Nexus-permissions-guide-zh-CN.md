...
1. 将 Nexus-description-en.bbcode.txt 替换到详情页，或只将 Nexus-license-section-en.bbcode.txt 加入现有页面。已包含公开源码链接和 GNU 官方 GPL-3.0 直链。
...
网页权限设置必须在 N 网后台保存；本地文档和 GitHub 推送不会自动修改这些开关。